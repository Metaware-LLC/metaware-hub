...
>(({ className, children, ...props }, ref) => (
  <ScrollAreaPrimitive.Root ref={ref} className={cn("relative overflow-hidden group/scroll-area", className)} {...props}>
...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      "flex touch-none select-none transition-all duration-300 opacity-0 group-hover/scroll-area:opacity-100",
